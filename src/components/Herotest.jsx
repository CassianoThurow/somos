  ...
  return (
    isMobile ? (
      <section className="mt-16 flex flex-col justify-center h-screen bg-primary-yellow">
        ...
        <img src="./src/assets/teste2.png" alt="Descrição da imagem" className="w-full h-96 object-cover bg-center mt-8" />
      </section>
    ) : (
      <section className="relative flex items-center h-screen">
        ...
        <div className="container mx-auto px-4 z-20">
          <h1 className="text-4xl md:text-6xl text-white w-444 font-bold">Soluções 99 feitas pra você!</h1>
